    ...
    <div class="flex section-wrapper">
      <transition name="slide-fade" mode="out-in">
        <div
          ...
          "
          :style="
            !selectedService ? { backgroundImage: `url(${background})` } : {}
          "
        >
          <el-row class="h-full p-8 overflow-y-scroll">
            <el-col v-if="!selectedService" :span="24">
              ...
              <p class="nemo-subtitle">
                Tìm kiếm thông tin của các địa điểm du lịch thích hợp cùng trợ
                lý ảo Nemo.
              </p>
            </el-col>
                ...
                <el-col :span="24" style="background-color: #eafaf4;">
                  <div class="p-3 flex">
                    ...
                    <div>
                      ...
                      <span>
                        Trong thời điểm đại dịch Covid-19, mong quý khách theo
                        dõi thông tin và giữ an toàn khi đi du lịch.
                      </span>
                    </div>
                  </div>
                </el-col>
